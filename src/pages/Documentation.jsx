      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12 py-20">
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 leading-relaxed">
            Noctara is a modern game library platform designed with performance,
            scalability, and user experience in mind. The application ensures
            smooth navigation, dynamic rendering, and secure authentication
            management across all user interactions.
          </p>
        </section>
